...
import { EmailIcon, EyeFilledIcon, EyeSlashFilledIcon, LockIcon } from '../icons/icons'
      ...
      <div className='flex items-center justify-center w-full h-full'>
         <div className="flex flex-col gap-4 min-w-[300px] border-1 border-slate-600 rounded-lg p-3 bg-blue-300 backdrop-filter backdrop-blur-sm bg-opacity-10">
            ...
            <div className="flex flex-col justify-center">
               <Button color="primary" onClick={handleSignIn} className='font-semibold rounded-lg' variant="ghost">
